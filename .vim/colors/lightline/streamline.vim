" =============================================================================
" Filename: autoload/lightline/colorscheme/streamline.vim
" Author: argwhar
" License: MIT License
" Install: Copy or symlink it to lightline's "colorscheme" directory
" =============================================================================
...
let s:p.insert.left = [ ['darkestcyan', 'mediumcyan', 'bold'], ['white', 'gray4'] ]
...
let g:lightline#colorscheme#streamline#palette = lightline#colorscheme#fill(s:p)
